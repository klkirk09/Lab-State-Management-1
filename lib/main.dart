...
class _CounterPageState extends State<CounterPage> {
  ...
  List<Color> colors = [Colors.greenAccent, Colors.brown,
    Colors.white70, Colors.teal, Colors.tealAccent];

  // TODO: Step 2 – Add a variable to track the current background color
  // Example: Color currentColor = Colors.white;
  Color currentColor = Colors.tealAccent;
  ...
  void _increment() {
    setState(() {
      ...
      int colorNum = counter % colors.length;
      ...
      body: Center(
        child: Text(
          ...
          style: TextStyle(
            ...
            color: currentColor == Colors.brown? Colors.white: Colors.black,
